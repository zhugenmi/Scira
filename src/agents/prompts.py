...
8. clarification — 消息不明确，需要更多信息。workflow_mode = "none"
9. help — 请求帮助或使用说明。workflow_mode = "none"
...
{{
    "intent": "greeting|knowledge_query|full_research|search|generate_abstract|generate_introduction|generate_conclusion|clarification|help",
